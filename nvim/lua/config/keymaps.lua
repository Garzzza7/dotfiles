...
vim.keymap.set ("x", "<leader>p", '"_dP', { noremap = true, silent = true, desc = "Remember copied file after deletion" })
...
vim.keymap.set ("n", "<C-t>", "<cmd>ToggleTerm dir=%:p:h<cr>", { noremap = true, silent = true, desc = "Open ToggleTerm" })
