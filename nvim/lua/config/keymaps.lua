...
vim.keymap.set (
    ...
    "<Up>",
    '<cmd>echo "xddd"<cr>',
    { noremap = true, silent = true, desc = "xddd" }
)
vim.keymap.set (
    { "n", "v" },
    "<Down>",
...
vim.keymap.set (
    ...
    "<A-d>",
    "<cmd>Bclose<cr>",
    { noremap = true, silent = true, desc = "Delete buffer without closing the window" }
)
vim.keymap.set (
    { "n", "i", "v" },
    "<A-p>",
...
vim.keymap.set (
    ...
    "<A-w>",
    "<cmd>bw<cr> ",
    { noremap = true, silent = true, desc = "Write buffer" }
)
vim.keymap.set (
    { "n", "i", "v" },
    "<A-l>",
    "<cmd>ls<cr> ",
    { noremap = true, silent = false, desc = "Display buffers" }
)
...
vim.keymap.set (
    ...
    "<A-t>",
    "<cmd>Ex<cr>",
    { noremap = true, silent = true, desc = "Open netrw" }
)
...
vim.keymap.set (
    ...
    "J",
    ":m '>+1<cr>gv=gv",
    { noremap = true, silent = true, desc = "Move highlighted text down" }
)
vim.keymap.set (
    { "v" },
    "K",
    ":m '<-2<cr>gv=gv",
    { noremap = true, silent = true, desc = "Move highlighted text up" }
)
...
vim.keymap.set (
    ...
    "<leader>p",
    '"_dP',
    { noremap = true, silent = true, desc = "Remember copied stuff after deletion" }
)
...
vim.keymap.set (
    ...
    "<C-s><C-d>",
    ":GrepperGrep <C-r><C-w>",
    { noremap = true, silent = false, desc = "Run grepper" }
)
...
vim.keymap.set (
    ...
    ":%s/<C-r><C-w>//g<Left><Left>",
    {
        noremap = true,
        silent = false,
        desc = "Replace word from under the cursor without confirmation",
    }
)
...
vim.keymap.set (
    ...
    ":%s/<C-r><C-w>//gc<Left><Left><Left>",
    {
        noremap = true,
        silent = false,
        desc = "Replace word from under the cursor with confirmation",
    }
)
...
vim.api.nvim_set_keymap (
    ...
    { noremap = true, silent = true, desc = "Media Files" }
)
...
vim.keymap.set (
    { "n" },
    "<F9>",
    "<esc> :w <cr> :Dispatch<cr>",
    { noremap = true, silent = false, desc = "Run Dispatch" }
)
...
vim.keymap.set (
    ...
    { noremap = true, silent = true, desc = "Open TODOs" }
)
